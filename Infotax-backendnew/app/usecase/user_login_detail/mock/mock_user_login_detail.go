...
func (m *MockUseCaser) DeleteUserLoginDetail(ctx context.Context, filter in.EmployeeIDFilter) (out.DeleteResponse, *error.Error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaserMockRecorder) DeleteUserLoginDetail(ctx, filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "DeleteUserLoginDetail", reflect.TypeOf((*MockUseCaser)(nil).DeleteUserLoginDetail), ctx, filter)
}
...
func (m *MockUseCaser) GetUserLoginDetail(ctx context.Context, filter in.EmployeeIDFilter) (out.UserLoginDetail, *error.Error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaserMockRecorder) GetUserLoginDetail(ctx, filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserLoginDetail", reflect.TypeOf((*MockUseCaser)(nil).GetUserLoginDetail), ctx, filter)
}

// GetUserLoginRole mocks base method.
func (m *MockUseCaser) GetUserLoginRole(ctx context.Context, filter in.EmployeeIDFilter) (out.UserLoginRole, *error.Error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaserMockRecorder) GetUserLoginRole(ctx, filter interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetUserLoginRole", reflect.TypeOf((*MockUseCaser)(nil).GetUserLoginRole), ctx, filter)
}

// UpdateUserLoginDetail mocks base method.
func (m *MockUseCaser) UpdateUserLoginDetail(ctx context.Context, detail in.UpdateUserDetail) (out.UpdateResponse, *error.Error) {
	m.ctrl.T.Helper()
...
func (mr *MockUseCaserMockRecorder) UpdateUserLoginDetail(ctx, detail interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserLoginDetail", reflect.TypeOf((*MockUseCaser)(nil).UpdateUserLoginDetail), ctx, detail)
}
