...
type UseCaser interface {
	GetUserLoginDetail(ctx context.Context, filter in.EmployeeIDFilter) (out.UserLoginDetail, *error.Error)
	GetUserLoginRole(ctx context.Context, filter in.EmployeeIDFilter) (out.UserLoginRole, *error.Error)
	GetAllUserLoginDetail(ctx context.Context) ([]out.UserLoginDetail, *error.Error)
	DeleteUserLoginDetail(ctx context.Context, filter in.EmployeeIDFilter) (out.DeleteResponse, *error.Error)
	CreateUserLoginDetail(ctx context.Context, detail in.CreateUserDetail) (out.SaveResponse, *error.Error)
	UpdateUserLoginDetail(ctx context.Context, detail in.UpdateUserDetail) (out.UpdateResponse, *error.Error)
}
